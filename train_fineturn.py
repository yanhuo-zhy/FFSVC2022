...
def save_model(save_path, epoch, model, classifier, optimizer, scheduler):
    torch.save({'model': model.state_dict(),
            ...
            }, os.path.join(save_path, 'model_layer1_%d.pkl' % epoch))
...
def train(model, train_dataloader, classifier, optimizer, scheduler, hyperparameters, epochs):
	...
	for epoch in range(0,epochs):
		...
		for i, (feats, key) in enumerate(train_dataloader, start = 1):
			...
			sys.stderr.flush()
		sys.stdout.write("\n")
		save_model("/home/zhy/FFSVC/exps/test", epoch, model, classifier, optimizer, scheduler)
...
def main():
	...
	model, classifier = get_pretrain("/home/zhy/FFSVC/pretrain.model",7325)
